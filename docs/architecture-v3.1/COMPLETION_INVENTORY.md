...
| src/kernel/cycle-deps.ts:536 | `outstanding: String(Number(r.total_amount ?? 0) - Number(r.amount_settled ?? 0)),` |
...
| src/kernel/cycle-deps.ts:418 | `error-discarding destructure` |
