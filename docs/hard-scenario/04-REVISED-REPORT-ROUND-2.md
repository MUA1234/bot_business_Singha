...
the topology fix, and again after migration 0110 was applied.
...
### F-004 — bounded user text (`0110_bounded_user_text.sql`)
...
# Roll back migration 0110 on a local database:
