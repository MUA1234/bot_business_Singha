...
R1 fixes, migration 0110, the campaign harness and suites, and the reports — with no
...
- `src/db/migrations/0110_bounded_user_text.sql` and the `dec()` hardening (F-004, F-005).
