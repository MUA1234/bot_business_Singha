...
| Category | Count |
|---|---|
| **Verified** (locally / preview / staging / production) | **23** |
| **Incomplete and implementable** (absent + specified + foundation_only + in_progress + unverified) | **62** |
| **Blocked — owner** | **4** |
| **Blocked — external** | **0** |
...
mode. Incomplete and implementable: **62**; blocked (owner): **4**;
