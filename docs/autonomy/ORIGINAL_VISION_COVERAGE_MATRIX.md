...
| Category | Count |
|---|---|
| **Verified** (locally / preview / staging / production) | **24** |
| **Incomplete and implementable** (absent + specified + foundation_only + in_progress + unverified) | **61** |
| **Blocked — owner** | **4** |
| **Blocked — external** | **0** |
...
mode. Incomplete and implementable: **61**; blocked (owner): **4**;
