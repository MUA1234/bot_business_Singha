 ...
 *
 * The database computes the fingerprint (migration 0072: `task_identity_hash`, recomputed by a
 ...
 * concern (2) of migration 0072 — semantic similarity — which is advisory by design and never
