/**
 * Reusable Command Centre panel. Used by the full `/app/command` page and by the
 * spatial workspace window. It is a pure data + presentation component; it does not
 * perform permission checks (the caller must do that).
 */
