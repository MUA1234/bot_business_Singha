...
export default async function QuotationPage({ params }: { params: { token: string } }) {
  ...
  return (
    <>
      ...
      <style>{`
        .qpage{background:#f3eef8;min-height:100vh;padding:32px 16px;color:#1a1024;font-family:-apple-system,Segoe UI,Roboto,Helvetica,Arial,sans-serif}
        .qdoc{max-width:820px;margin:0 auto;background:#fff;border-radius:20px;overflow:hidden;box-shadow:0 24px 60px -24px rgba(90,20,112,.5)}
        .qhead{display:flex;justify-content:space-between;align-items:flex-start;padding:28px 32px;background:linear-gradient(135deg,#2c0a3d,#7a1f6a);color:#fff}
        ...
        .qparties h4{margin:0 0 6px;font-size:.72rem;text-transform:uppercase;letter-spacing:.06em;color:#9a7bb0}
        table.q{width:100%;border-collapse:collapse;font-size:.92rem}
        table.q th{text-align:left;background:#f4ecfa;color:#6a3a86;padding:10px 12px;font-size:.72rem;text-transform:uppercase;letter-spacing:.04em}
        ...
        .qtotal .grand{border-top:2px solid #7a1f6a;margin-top:6px;padding-top:10px;font-weight:800;color:#7a1f6a;font-size:1.1rem}
