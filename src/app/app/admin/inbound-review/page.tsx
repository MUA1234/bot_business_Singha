...
export default async function InboundReviewPage() {
  ...
  try {
    ...
    // The table arrives with migration 0076. Say so rather than rendering a confident empty queue.
    unavailable = true;
  }
    ...
    <div className="stack gap-3">
      ...
      {unavailable && (
        <div className="notice err">
          The review queue table is not present in this database yet (migration 0076). Nothing is
