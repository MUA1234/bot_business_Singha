...
--
-- THE FIX is the same discipline migration 0079 applied to routing decisions: provenance is
...
-- `caller_jwt_role()` is the same trusted-context signal migrations 0078/0078 use. The default is
