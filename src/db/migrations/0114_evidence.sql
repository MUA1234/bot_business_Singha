-- Release 1 — promoted from R1_DRAFT_003 on 2026-09-11.
--
...
-- recovery markers absent), so the owner approved promotion and this is now migration 0113,
...
-- src/db/rollback/0113_*.down.sql; the forward runner never sees it.
--
