-- Release 1 — promoted from R1_DRAFT_011 on 2026-09-11.
--
...
-- recovery markers absent), so the owner approved promotion and this is now migration 0121,
...
-- src/db/rollback/0121_*.down.sql; the forward runner never sees it.
--
