-- Release 1 — promoted from R1_DRAFT_022 on 2026-09-11.
--
...
-- recovery markers absent), so the owner approved promotion and this is now migration 0132,
...
-- src/db/rollback/0132_*.down.sql; the forward runner never sees it.
--
