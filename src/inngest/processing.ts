...
export interface CompanyContext {
  ...
  /** The PERSON who submitted, or null when the pipeline itself did (OF-013 / migration 0082). */
 ...
 * assume a single execution: `createDraft` is idempotent per source event and migration 0083 makes
